module Snake(
	...
	always @(posedge clk or negedge rst) begin
		...
		if(sudu==0)
		cnt2 <= 25_000_000;
		else cnt2 <= 12_500_000;
		 cnt <= cnt + 1;
			if(cnt == cnt2) begin   //速度控制
				cnt <= 0;
				if(game_status == PLAY) begin
					if((direct == UP && cube_y[0] == 1)|(direct == DOWN && cube_y[0] == 28)|(direct == LEFT && cube_x[0] == 1)|(direct == RIGHT && cube_x[0] == 33))
					   hit_wall <= 1; //撞到墙壁
...
//吃下苹果没？，吃下则add_cube==1，显示体长增加一位，"is_exixt[cube_num]<=1",让第cube_num位"出现"		
		if(!rst) begin
			is_exist <= 16'd15;
			cube_num <= 4;
			addcube_state <= 0;//初始显示长度为4，is_exist=0000_0000_1111,表示前四位出现
		end  
		else if (game_status == RESTART) begin
		      is_exist <= 16'd15;
              cube_num <= 4;
	...
	always @(x_pos or y_pos ) begin				
		if(x_pos >= 0 && x_pos < 640 && y_pos >= 0 && y_pos < 480) begin
			if(x_pos[9:4] == 0 | y_pos[9:4] == 0 | x_pos[9:4] == 34 | y_pos[9:4] == 29|((x_pos[9:4]<39&&x_pos[9:4]>35)&&(y_pos[9:4]==2))|((x_pos[9:4]==36)&(y_pos[9:4]==3))|((x_pos[9:4]<39&x_pos[9:4]>35)&(y_pos[9:4]==4))|((x_pos[9:4]==36)&(y_pos[9:4]==5))|((x_pos[9:4]<39&&x_pos[9:4]>35)&&(y_pos[9:4]==6))|((x_pos[9:4]<39&&x_pos[9:4]>35)&&(y_pos[9:4]==8))|((x_pos[9:4]==36)&&(y_pos[9:4]==9))|((x_pos[9:4]<39&&x_pos[9:4]>35)&&(y_pos[9:4]==10))|((x_pos[9:4]==38)&&(y_pos[9:4]==11))|((x_pos[9:4]<39&&x_pos[9:4]>35)&&(y_pos[9:4]==12))|((x_pos[9:4]<39&&x_pos[9:4]>35)&&(y_pos[9:4]==14))|((x_pos[9:4]==36)&&(y_pos[9:4]==15))|((x_pos[9:4]<39&&x_pos[9:4]>35)&&(y_pos[9:4]==16))|((x_pos[9:4]==36)&&(y_pos[9:4]==17))|((x_pos[9:4]<39&&x_pos[9:4]>35)&&(y_pos[9:4]==18)))
				snake = WALL;//扫描墙
